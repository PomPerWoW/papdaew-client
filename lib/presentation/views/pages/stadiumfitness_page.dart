...
class StadiumFitnessPage extends StatelessWidget {
  const StadiumFitnessPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Stadium/Fitness")),
...
class AthleticsCard extends StatelessWidget {
          ...
          ? () {
              showDialog(
                ...
                builder: (context) => AlertDialog(
                  ...
                  content: const Text(
                    "This Athletics is outside your service area.",
